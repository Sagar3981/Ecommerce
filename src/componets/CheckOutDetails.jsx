...
import { IoMdStar, IoMdLocate } from "react-icons/io";
                        ...
                        <div className="checkout-login">
                            ...
                            <div className="checkout-login-details">
                                ...
                                <div className="checkout-login-div2">
                                    ...
                                    <h1 className="advantages-text">
                                        <RiTruckFill className="checkout-login-icons" /> easily
                                        track orders, hassle free returns
                                    </h1>
                                    <h1 className="advantages-text">
                                        <FaBell className="checkout-login-icons" /> get relevant
                            ...
                            <div className="note">
                                <p>
                                    ...
                                    items in the cart and will be redirected to the Flipkart home
                                    page.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="product-sum">
                                    {productData.map((row, index) => {
                                        ...
                                        const discountedPrice =
                                            (price - discountValue) * row.quantity;
                                        return (
