        ...
        <div className="checkout-main-container">
            <div className="checkout-deatils">
                ...
                <div className="cart-product-top-row">
                    ...
                    <img className="cart-product-image" src="/public/assets/img/xl-fms-181-fllseve-pop-ol-force-original-imah459zhrvvjp4m.webp"/>
                </div>
                <div className="cart-product-detils">
                    <h1 className="cart-product-name">Veirdo Full Sleeve Printed Men Sweatshirt</h1>
