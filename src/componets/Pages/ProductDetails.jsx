...
const ProductDetails = () => {
  ...
  const GetProductDetails = async () => {
    try {
      const response = await BackEndApi.get(`/product/getsingleproduct/${id}`);
              ...
              <div className="product-info-container">
                ...
                <div className="offers-container">
                  ...
                  <div className="offer-item">
                    <span>🏷️</span> 5% Cashback on Flipkart Axis Bank Credit
                    Card
                ...
                <div className="info-section mt-3">
                  <div>
                    <span className="info-label">Warranty</span> 1 Year PLAY
                    STORE Warranty. Contact: 9577 454 454 /
                ...
                <div className="specs-box mt-4">
                  ...
                  <div className="specs-section">
                    ...
                    <div className="spec-item">
                      <b>Sales Package:</b> Advance Play Projector*1, User
                      manual *1, Remote controller *1, AV cable *1, Warranty
                      Card*1, Power Cable*1, 3D Glass*1
                    </div>
                    <div className="spec-item">
